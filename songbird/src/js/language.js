const languageSettings = {
  ...
  en: [
    ...
    "Quiz",
    "Gallery",
    `<h1 class="intro__title">Greetings!</h1>
  <p class="intro__text">
    Birds are too boring, so try to guess Warcraft 3 characters by their voices!
  </p>`,
    "Start quiz",
    "Training",
    "Alliance",
    ...
    "Horde",
    "Tavern heroes",
    "Listen to the player and select a character from the list.",
    "Next level",
    "Finish the game",
